              ...
              {pricingData.map((plan, idx) => (
                ...
                >
                  <div className="p-8 relative">
                    ...
                    <p className="text-white text-xl mb-6 leading-relaxed h-10 line-clamp-2">{plan.description}</p>
          ...
          <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-12">
            ...
            <div>
              ...
              <div className="bg-white/5 p-6 rounded-3xl border border-white/10">
                <a href="tel:+919186194900" className="flex items-center gap-4 text-xl font-black hover:text-brand-pink transition-colors"><Phone size={20} /> +91 9186194900</a>
              </div>
            </div>
          </div>
